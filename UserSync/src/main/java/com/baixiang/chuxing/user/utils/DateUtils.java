...
import com.baixiang.chuxing.user.format.FormatDateTime;
import com.baixiang.chuxing.user.common.Utility;
...
public class DateUtils
{
	 ...
	 * @return Date 转换失败则返回NULL
	 */
	public static Date convertSqlTimestampToDate(Timestamp datetime)
	{
		try
		{
		    Date date = new Date(datetime.getTime());
